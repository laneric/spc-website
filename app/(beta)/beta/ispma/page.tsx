  ...
  return (
    <div className="min-h-screen bg-[#FAFAF9] text-zinc-900 pt-24">
      <div className="max-w-5xl mx-auto w-full px-16 py-16">
        {/* Header */}
        <h1 className="text-4xl sm:text-5xl md:text-[72px] tracking-tight font-medium text-black mb-6">
          ISPMA
        </h1>
            ...
            <div className="rounded-xl overflow-hidden bg-white border border-zinc-200/80">
              ...
              <div className="p-8">
                ...
                <div className="mt-6 flex flex-wrap gap-2">
                  <span className="inline-flex px-3 py-1.5 rounded-full bg-zinc-200/80 text-zinc-800 text-sm font-medium">
                    Talks
                  </span>
                  <span className="inline-flex px-3 py-1.5 rounded-full bg-zinc-200/80 text-zinc-800 text-sm font-medium">
                    Workshops
            ...
            <div className="rounded-xl overflow-hidden bg-white border border-zinc-200/80">
              ...
              <div className="p-8">
                ...
                <div className="mt-6 space-y-2">
                  <p className="text-sm font-medium text-black">What delegates do</p>
                  <ul className="space-y-2">
                    {[
                      ...
                      <li
                        key={item}
                        className="flex gap-2 text-zinc-600 text-sm font-medium"
                      >
                        <span
                          className="mt-1.5 h-1.5 w-1.5 rounded-full bg-zinc-400 shrink-0"
                          aria-hidden
                        />
                        {item}
                      </li>
        ...
        <section className="mt-20">
          <h2 className="text-3xl sm:text-4xl font-medium text-black tracking-tight mb-8 max-w-2xl">
          ...
          <a
            ...
            className="inline-flex px-4 py-2 rounded-full bg-[#F2F2F2] text-black text-sm font-medium hover:bg-zinc-200 transition-colors"
          >
            Visit ISPMA
          </a>
        </section>
